...
const VIEW_SESSION_UPDATE_INTERVAL_MS = 1000; // 1초마다 체류 시간 업데이트
const MOUSE_MOVE_THROTTLE_MS = 1000; // 1초에 한 번만 마우스 이동 기록
const SCROLL_THROTTLE_MS = 1000; // 1초에 한 번만 스크롤 카운트
